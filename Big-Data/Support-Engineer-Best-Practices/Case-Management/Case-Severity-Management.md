...
And **an important talking point** with customers is that they can raise the severity back to A when they encounter any emergency at any time, let them aware that downgrading to B never means we will relax and don't care about their issue. For Prem case, if customer is not following the policy and requesting to keep as A unreasonably, you can engage TAM to talk with customer. 
