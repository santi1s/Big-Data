If a customer is having trouble viewing their metrics from the ASA job page of the Azure Portal, they can try to view the metrics via the Azure Monitor:
